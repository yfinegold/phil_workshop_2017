...
# setwd('C:/Users/finegold/Desktop/philippines/maps/phil/')
...
# set pixel size of output raster (in meters)
pixelsize <- 30
...
dbf03[dbf03$Class_2 %in% c('Forest')]$fnf <- 1
dbf03[!dbf03$Class_2 %in% c('Forest')]$fnf <- 2

dbf10[dbf10$AGG14 %in% c("Closed Forest",'Mangrove Forest','Open Forest')]$fnf <- 1
dbf10[!dbf10$AGG14 %in% c("Closed Forest",'Mangrove Forest','Open Forest')]$fnf <- 2
